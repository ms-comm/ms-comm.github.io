...
(function () {
  ...
  const DICT = {
    ...
    "L'Atelier.": "The Atelier.",
    "L'Atelier | MS Comm'": "The Atelier | MS Comm'",
    "L'atelier": "The Atelier",
    ...
    "Gratuit": "Free",
    "Aperçu": "Preview",
    "Avec filigrane": "With watermark",
    "Avec filigrane MS Comm’": "With MS Comm’ watermark",
    "Acheter l’original": "Buy the original",
    "Acheté": "Purchased",
    "Original": "Original",
    "Sans filigrane": "Without watermark",
    "Sans aucun filigrane": "Without any watermark",
    "Pleine résolution": "Full resolution",
    "Quel format vous convient ?": "Which format suits you?",
    "Télécharger gratuitement": "Download for free",
    "Personnaliser dans L’atelier": "Personalize in The Atelier",
    "Démarrer une création avec cette photo.": "Start a creation with this photo.",
    "Le fichier original sera disponible au téléchargement après achat.": "The original file will be available to download after purchase.",
    "L’aperçu gratuit conserve le filigrane MS Comm’.": "The free preview keeps the MS Comm’ watermark.",
    "Votre photo, dans sa plus belle définition.": "Your photo, in its best resolution.",
    "Choisissez votre version :": "Choose your version:",
