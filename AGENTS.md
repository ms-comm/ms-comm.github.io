...
- **Mobile download controls**: Album/order download buttons keep icon + text on desktop and icon-only under 600px, with `aria-label`/`title` retained. Cart icon uses flex centering with no baseline offset.
